...
public class iTween : MonoBehaviour
{
	...
	public static void LocalMoveTo(GameObject target, Vector3 pos, float time)
	{
		MoveTo(target, Hash("position", pos, "islocal", true, "time", time, "easetype", EaseType.easeInOutQuad));
	}

	public static void LinerLocalMoveTo(GameObject target, Vector3 pos, float time)
	{
		MoveTo(target, Hash("position", pos, "islocal", true, "time", time, "easetype", EaseType.linear));
	}

	public static void LinerMoveTo(GameObject target, Vector3 pos, float time)
	{
		MoveTo(target, Hash("position", pos, "time", time, "easetype", EaseType.linear));
	}

	public static void LinerMoveByPath(GameObject target, Vector3[] path, float time)
	{
		Hashtable hashtable = new Hashtable();
		hashtable["path"] = path;
		hashtable["time"] = time;
		hashtable["easetype"] = EaseType.linear;
		MoveTo(target, hashtable);
	}

	public static void LinerScaleTo(GameObject target, Vector3 scale, float time)
	{
		ScaleTo(target, Hash("scale", scale, "time", time, "easetype", EaseType.linear));
	}

	public static void LinerRotationTo(GameObject target, Vector3 rotaion, float time)
	{
		RotateTo(target, Hash("rotation", rotaion, "time", time, "easetype", EaseType.linear));
	}

	public static void LinerLocalRotationTo(GameObject target, Vector3 rotaion, float time)
	{
		RotateTo(target, Hash("rotation", rotaion, "time", time, "easetype", EaseType.linear, "islocal", true));
	}
}
